...
class WV(object):
    ...
    def get_W2Vec(self, wv_dim = 300, n_epochs = 1, batch_size = 50, article_batch_size = 5, word_list_to_test = None, cuda = True):
        ...
        if cuda is False:
            ...
            print('List of GPU: ', tf.config.list_physical_devices('GPU'))
            tf.config.threading.set_intra_op_parallelism_threads(4)
            tf.config.threading.set_inter_op_parallelism_threads(2)
            print('get_intra_op_parallelism_threads: ', tf.config.threading.get_intra_op_parallelism_threads())
            print('get_inter_op_parallelism_threads: ', tf.config.threading.get_inter_op_parallelism_threads())
            time.sleep(5)
